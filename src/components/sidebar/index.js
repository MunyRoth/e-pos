    ...
    render() {
        return (
            <>
                ...
                <aside id="logo-sidebar"
                    ...
                    <div className="h-full px-3 overflow-y-auto bg-white dark:bg-gray-800">
                        <Link
                            ...
                            />
                            <span
                                className="self-center text-xl font-semibold whitespace-nowrap sm:text-2xl dark:text-white">ePOS</span>
                        </Link>
                        <ul className="space-y-2 font-medium mt-4">
                            <li>
                                <Link
                                    to="dashboard"
                                    className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-whites dark:hover:bg-gray-700"
                                >
                                    <svg
                                        aria-hidden="true"
                            ...
                            {/*    <button*/}
                            {/*        onClick={() => {*/}
                            {/*            this.setState({isShowECommerce: true})*/}
                            {/*        }}*/}
                            {/*        type="button"*/}
                            ...
                            {/*            <li>*/}
                            {/*                <Link to="products"*/}
                            {/*                      className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Products</Link>*/}
                            {/*            </li>*/}
                            {/*            <li>*/}
                            {/*                <Link to="bills"*/}
                            {/*                      className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Billing</Link>*/}
                            {/*            </li>*/}
                            {/*            <li>*/}
                            {/*                <Link to="invoices"*/}
                            {/*                      className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Invoice</Link>*/}
                            {/*            </li>*/}
                            {/*        </ul>*/}
                            {/*    )}*/}
                            {/*</li>*/}
                ...
                <div className="h-screen overflow-auto p-4 sm:ml-64">
